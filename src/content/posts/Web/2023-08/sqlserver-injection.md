...
![](/images/posts/sqlserver-injection/1.png)
...
![](/images/posts/sqlserver-injection/2.png)
...
![](/images/posts/sqlserver-injection/3.png)

![](/images/posts/sqlserver-injection/4.png)

**PS：但是如果用navicat远程连接的话，只会显示2个实例数据库：ReportServer、ReportServerTempDB**

![](/images/posts/sqlserver-injection/5.png)

### **修改默认1433端口**

打开SQLServer配置管理器——>SQLServer网络配置——>MSSQLSERVER的协议——>TCP/IP，右键属性

![](/images/posts/sqlserver-injection/6.png)

![](/images/posts/sqlserver-injection/7.png)

![](/images/posts/sqlserver-injection/8.png)

### SQLServer数据库的管理

![](/images/posts/sqlserver-injection/9.png)

服务器名称：主机,端口

**Windows身份验证管理**

![](/images/posts/sqlserver-injection/10.png)

**SQLServer身份验证管理**

![](/images/posts/sqlserver-injection/11.png)
...
```sql
PS：在较新版本的SQL Server中数据库和模式之间的三点省略号 .. 在某些情况下可能会引发问题。通常，应该明确指定数据库和模式名称，以确保查询正常运行。
尝试以下修正：
...
![](/images/posts/sqlserver-injection/12.png)
...
![](/images/posts/sqlserver-injection/13.png)

![](/images/posts/sqlserver-injection/14.png)
...
![](/images/posts/sqlserver-injection/15.png)
...
![](/images/posts/sqlserver-injection/16.png)

再次执行命令，发现不报错。此时可以执行系统命令了，但是使用 sp_oacreate 执行系统命令不回显

![](/images/posts/sqlserver-injection/17.png)
...
![](/images/posts/sqlserver-injection/18.png)

![](/images/posts/sqlserver-injection/19.png)
...
- 目标机器存在数据库备份文件 ，也就是如果我们利用 test 数据库的话，则需要该test数据库存在数据库备份文件，而且恢复模式得是 完整模式
  ...
  ```sql
  BACKUP DATABASE YourDatabaseName TO DISK = 'D:\Backup\YourDatabaseName.bak'    -- 完整备份
  ```
...
![](/images/posts/sqlserver-injection/20.png)

![](/images/posts/sqlserver-injection/21.png)

![](/images/posts/sqlserver-injection/22.png)

![](/images/posts/sqlserver-injection/23.png)

![](/images/posts/sqlserver-injection/24.png)

![](/images/posts/sqlserver-injection/25.png)

会在目标网站根目录下生成1.php和2.php文件，其中1.php 保存数据库，2.php就是我们需要连接的木马文件。

![](/images/posts/sqlserver-injection/26.png)

用菜刀连接即可

![](/images/posts/sqlserver-injection/27.png)
...
- 第四行的0x43003A005C00700068007000730074007500640079005C005700570057005C007300680065006C006C002E00700068007000是  C:\phpstudy\WWW\shell.php 的16进制表示
  ...
  **（这里第四行使用的是UTF-16LE格式，因为 `image` 数据类型通常用于存储二进制数据，而这个数据在SQL Server中表示为字节序列。）**

  **CyberChef首先进行hex转化，然后utf-16LE进行decode**

![](/images/posts/sqlserver-injection/28.png)

![](/images/posts/sqlserver-injection/29.png)

![](/images/posts/sqlserver-injection/30.png)

![](/images/posts/sqlserver-injection/31.png)

![](/images/posts/sqlserver-injection/32.png)

![](/images/posts/sqlserver-injection/33.png)

然后会在目标网站根目录下生成shell.php木马文件

![](/images/posts/sqlserver-injection/34.png)

用菜刀连接即可

![](/images/posts/sqlserver-injection/35.png)
...
![](/images/posts/sqlserver-injection/36.png)

![](/images/posts/sqlserver-injection/37.png)
...
![](/images/posts/sqlserver-injection/38.png)
...
![](/images/posts/sqlserver-injection/39.png)

正常显示，说明已开启。如果不存在，则需要开启。

如果开启后，想要通过xp_cmdshell执行系统命令，需要该注入点存在堆叠注入

![](/images/posts/sqlserver-injection/40.png)
...
![](/images/posts/sqlserver-injection/41.png)
...
![](/images/posts/sqlserver-injection/42.png)
...
![](/images/posts/sqlserver-injection/43.png)
...
![](/images/posts/sqlserver-injection/44.png)

![](/images/posts/sqlserver-injection/45.png)
...
![](/images/posts/sqlserver-injection/46.png)

查询机器名

![](/images/posts/sqlserver-injection/47.png)

查询所有数据库名

![](/images/posts/sqlserver-injection/48.png)

## 堆叠注入

![](/images/posts/sqlserver-injection/49.png)
...
![](/images/posts/sqlserver-injection/50.png)
...
![](/images/posts/sqlserver-injection/51.png)
...
![](/images/posts/sqlserver-injection/52.png)

![](/images/posts/sqlserver-injection/53.png)
...
![](/images/posts/sqlserver-injection/54.png)
...
![](/images/posts/sqlserver-injection/55.png)

菜刀连接之

![](/images/posts/sqlserver-injection/56.png)
...
![](/images/posts/sqlserver-injection/57.png)

连接下载的shell2.php木马即可！

![](/images/posts/sqlserver-injection/58.png)

## 还原备份数据库

鼠标右键数据库——>还原数据库

![](/images/posts/sqlserver-injection/59.png)

选择源设备，选择我们的备份数据库。然后目标数据库也选择该备份数据库，还原那里打上勾，点击确定即可。

![](/images/posts/sqlserver-injection/60.png)